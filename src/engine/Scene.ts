...
export class Scene {
    ...
    //Debug modes
    CONTROLS : boolean; //toggle orbit controls
    DEBUG_MODE : boolean;
    ...
    constructor(hostComponent: Canvas){
        ...
        //load canvas config
        const config = this.canvas.config;
        this.CONTROLS = config.CONTROLS;
        this.DEBUG_MODE = config.DEBUG_MODE;

        this.scene = new THREE.Scene();
        this.scene.background= new THREE.Color(this.canvas.data.backgroundColor)
        ...
        //Create World
        this.world = new World(this, this.canvas.data.world);
